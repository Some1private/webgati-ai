...
import { OpenRouterFormFields } from "./OpenRouterFormFields";
          ...
          <Stack spacing="sm">
            ...
            <Select
              ...
              data={[
                ...
                { value: MODEL_PROVIDER_OPENROUTER, label: "OpenRouter" },
              ]}
              value={modelProvider}
            ...
            <form onSubmit={form.onSubmit(handleSubmit)}>
              ...
              {modelProvider === MODEL_PROVIDER_OPENROUTER && (
                <ModelFormFields
                  form={form}
                  modelProvider={MODEL_PROVIDER_OPENROUTER}
                  FormFieldsComponent={OpenRouterFormFields}
                />
              )}
